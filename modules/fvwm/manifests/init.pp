class fvwm {
package {
        ["gtk-theme-switch","gtk2-engines-oxygen","ssh-askpass","wpasupplicant","acpi-support","keynav","fvwm","xfonts-terminus","xfonts-wqy","tmux","rxvt-unicode","fcitx-googlepinyin","encfs","p7zip-full","git-core","dmz-cursor-theme","gnupg-agent"]:
        ensure => installed;
}
